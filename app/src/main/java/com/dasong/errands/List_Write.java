...
//         mMapViewContainer.addView(recyclerView);
        locationAdapter = new LocationAdapter(List_Write.this, documentArrayList, getApplicationContext(), mstart, recyclerView ,"mstart");
        locationAdapter2 = new LocationAdapter(List_Write.this, documentArrayList, getApplicationContext(), marrive, recyclerView2,"marrive");
